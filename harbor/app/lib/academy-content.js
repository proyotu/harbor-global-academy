  ...
  },
  {
    ...
    lessons: [
      ...
      videoLesson(
        ...
        'mini-touch-aufbau-wassertank',
        localized('Mini Touch – Aufbau und Wassertank', 'Mini Touch – Setup and Water Tank'),
        localized('Geräteaufbau, Wassertank und sichere Grundbedienung.', 'Device setup, water tank and safe basic operation.'),
        localized('Aufbau und Handhabung des Wassertanks sicher erklären.', 'Explain the setup and handling of the water tank safely.'),
      ),
      videoLesson(
        'video-mini-touch-touchdisplay-wasserausgabe',
        'mini-touch-touchdisplay-wasserausgabe',
        localized('Mini Touch – Touchdisplay und Wasserausgabe', 'Mini Touch – Touch Display and Water Dispensing'),
        localized('Bedienoberfläche, Wasserwahl und Wasserentnahme.', 'User interface, water selection and dispensing.'),
        localized('Die grundlegende Bedienung und Wasserausgabe sicher demonstrieren.', 'Demonstrate the basic operation and water dispensing safely.'),
      ),
      videoLesson(
        'video-mini-touch-filterwechsel-wartung',
        'mini-touch-filterwechsel-wartung',
        localized('Mini Touch – Filterwechsel und Wartung', 'Mini Touch – Filter Replacement and Maintenance'),
        localized('Filterkartuschen, Filterstatus und Wartungsablauf.', 'Filter cartridges, filter status and maintenance workflow.'),
        localized('Den vorgesehenen Filterwechsel und die Wartungsanzeige nachvollziehen.', 'Understand the intended filter replacement and maintenance display.'),
      ),
      videoLesson(
        'video-untertischanlage-bedienung-flush-wartung',
        'untertischanlage-bedienung-flush-wartung',
        localized('Untertischanlage – Bedienung, Flush und Wartung', 'Undersink System – Operation, Flushing and Maintenance'),
        localized('Bedienung, Statusanzeigen, Flush, Reset und Wartung.', 'Operation, status indicators, flushing, reset and maintenance.'),
        localized('Die vorhandenen Bedien- und Wartungsschritte sicher einordnen.', 'Classify the available operation and maintenance steps safely.'),
      ),
      videoLesson(
        'video-sparkling-pro-bedienung-systemaufbau',
        'sparkling-pro-bedienung-systemaufbau',
        localized('Sparkling Pro – Bedienung und Systemaufbau', 'Sparkling Pro – Operation and System Setup'),
        localized('Bedienfeld, Wasserausgabe und technischer Systemaufbau.', 'Control panel, water dispensing and technical system setup.'),
        localized('Sparkling Pro korrekt bedienen und den sichtbaren Systemaufbau erklären.', 'Operate Sparkling Pro correctly and explain the visible system setup.'),
      ),
